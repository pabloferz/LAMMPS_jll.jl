...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import LAMMPS_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("5b3ab26d-9607-527c-88ea-8fe5ba57cafe"))
platforms = [Pkg.Artifacts.unpack_platform(e, "LAMMPS", artifacts_toml) for e in artifacts["LAMMPS"]]
...
if best_platform === nothing
    @debug("Unable to load LAMMPS; unsupported platform $(triplet(platform_key_abi()))")
else
